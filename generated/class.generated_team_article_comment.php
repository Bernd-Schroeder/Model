     ...
     extends general_group
{
    ...
    /**
     *
     * This is the insert function of the class team_article_comment
    ...
    public function insert()
    {
      ...
      "INSERT INTO team_article_comment
      (
      id,
      deleted,
      author_id,
    ...
    /**
     *
     * This is the load function of the class team_article_comment
     * @author Bernd Schröder
     *
     */
    public function load()
    {
      ...
      text,
      media_id
      FROM team_article_comment WHERE id=?"))
      {
    ...
    /**
     *
     * This is the update function of the class team_article_comment
     * @author Bernd Schröder
     *
     */
    public function update()
    {
      ...
      $id = $this->get_id();
      if( $stmt = $mysqli->prepare(
      "UPDATE team_article_comment SET
      id=?,
      deleted=?,
      author_id=?,
      article_id=?,
    ...
    /**
     *
     * This is the delete function of the class team_article_comment
     * @author Bernd Schröder
     *
     */
    public function delete()
    {
      ...
      $id = $this->get_id();
      if( $stmt = $mysqli->prepare(
      "DELETE FROM team_article_comment
      WHERE id=?"))
      {
      $stmt->bind_param("i",  $id);
      $stmt->execute();
