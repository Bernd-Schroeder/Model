...
class generated_event_article_list
     extends basic_list
{

    /**
     *
     * This attribute hold the handle to the Mysqli statement event_article
    ...
    /**
     *
     * This is the list_load function of the class event_article
     * @author Bernd Schröder
     *
     */
    ...
    /**
     *
     * This is the basic_count function of the class event_article
     * @author Bernd Schröder
     *
     */
    ...
    /**
     *
     * This is the basic_load function of the class event_article
     * @author Bernd Schröder
     *
     */
    public function basic_load( $prepare_statement )
    {
      ...
      require_once(__GEN_ROOT__.'/class.event_article.php');
    ...
    /**
     *
     * This is the prepare_list function of the class event_article
     * @author Bernd Schröder
     *
     */
    public function get_prepare_list()
    {
      ...
      "
      event_article.id,
      event_article.deleted,
      event_article.owner_id,
      event_article.author_id,
      event_article.written_stamp,
    ...
    /**
     *
     * This is the set_binding function of the class event_article
     * @author Bernd Schröder
     *
     */
