    ...
    extends member_navigation
{
    ...
    {
     $team_list = $this->get_admin_team_list();
     
     if( $team_list->get_item_count() > (int)0 )
     return TRUE;
     else
     return FALSE;
    }
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function get_active_receiver_task_workload()
    {
     $workload = (int)0;
     $task_list = $this->get_active_receiver_task_list();
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function get_active_receiver_undo_task_workload()
    {
     ;
    }
    /**
     ...
     * @author firstname and lastname of author, <author@example.org>
     */
    public function get_active_receiver_done_task_workload()
    {
     ;
    }
}?>