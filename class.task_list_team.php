...
/**
 * untitledModel - class.task_list_team.php
 *
 * $Id$
 *
 * This file is part of untitledModel.
 *
 * Automatically generated on 01.10.2015, 10:35:02 with ArgoUML PHP module 
...
// section 10-30-49-72--5360f815:1485918914a:-8000:000000000000155E-includes begin
// section 10-30-49-72--5360f815:1485918914a:-8000:000000000000155E-includes end

/* user defined constants */
// section 10-30-49-72--5360f815:1485918914a:-8000:000000000000155E-constants begin
// section 10-30-49-72--5360f815:1485918914a:-8000:000000000000155E-constants end

/**
 * Short description of class task_list_team
 *
 * @access public
 * @author firstname and lastname of author, <author@example.org>
 */
class task_list_team
    extends task_list
{
    // --- ASSOCIATIONS ---
    ...
    public function set_binding()
    {
     ...
     $date = $this->date;
     $this->stmt->bind_param('iis', $owner_id, $user_id, $date );
    }
    /**
     *
     * @access public
    ...
    {
     $where_statement =
     "WHERE team_id=? AND receiver_id=? AND end_item_date>=?
    ...
    {
     $where_statement =
     "WHERE team_id=? AND receiver_id=? AND status!=1 AND end_item_date>=?
     ORDER BY end_item_date ASC";
     return $this->list_load( $where_statement );
    }
    /**
    ...
    {
     $where_statement =
     "WHERE team_id=? AND author_id=? AND end_item_date>=?
     ORDER BY end_item_date ASC";
     return $this->list_load( $where_statement );
    }
    /**
    ...
    public function get_active_author_undo_task_count()
    {
     $prepare_statement =
     "SELECT id FROM task
     WHERE team_id=? AND author_id=? AND status!=1 AND end_item_date>=?";
     return $this->basic_count( $prepare_statement );
    }
    /**
     *
